...
public class ETutorGradingController {
    ...
    /**
     * Takes the submissionId (ideally) generated by the ETutorSubmissionController and fetches and returns
     * the corresponding Grading. Returns HttpStatus.NOT_FOUND if no Grading is available for the given id.
