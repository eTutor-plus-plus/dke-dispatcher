        ...
        if(analysis instanceof DDLAnalysis ddlAnalysis) {
            ...
            if(!correctSyntaxCriterion.isCriterionSatisfied()) {
                if(locale == Locale.GERMAN) {
                    result.append("<strong>DDL-Statement konnte nicht ausgeführt werden!</strong>");
                } else {
                    result.append("<strong>DDL-Statement could not be executed!</strong>");
                }
                return result.toString();
            }

            if(locale == Locale.GERMAN) {
                result.append("<strong>DDL-Statement erfolgreich ausgeführt!</strong>");
            } else {
                result.append("<strong>DDL-Statement successfully executed!</strong>");
            }
