 ...
 * @since 1.0
 */
public class DLVWrappedDatalogProcessor {

    /**
     * The logger used for logging.
     */
    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(DLVWrappedDatalogProcessor.class);
     ...
     *             time span.
     */
    public DLVWrappedDatalogProcessor(
