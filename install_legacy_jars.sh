mvn install:install-file -Dfile=./src/main/resources/lib/xml.jar -DgroupId=at.jku.dke.etutor -DartifactId=legacy.javax.xml -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=./src/main/resources/lib/xml-apis.jar -DgroupId=at.jku.dke.etutor -DartifactId=legacy.javax.xml-apis -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=./src/main/resources/lib/xmlParserAPIs.jar -DgroupId=at.jku.dke.etutor -DartifactId=legacy.javax.parsers -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=./src/main/resources/lib/xmlparserv2.jar -DgroupId=at.jku.dke.etutor -DartifactId=legacy.javax.parsersv2 -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true
